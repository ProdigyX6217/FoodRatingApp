...
class MealTableViewController: UITableViewController {
        ...
        if let sourceViewController = sender.source as? MealViewController, let meal = sourceViewController.meal {
            ...
            if let selectedIndexPath = tableView.indexPathForSelectedRow {
                /*TODO: Update an existing meal
                 ...
                 2. use the method tableView.reloadRows with the selected indexPath and choose an animation style
                */
    ...
    private func saveMeals() {
        //TODO: Use JSONEncoder to get save data to Meals.txt located in Documents Directory
